...
sentence1 = book_name + " was written by " + author + " when they were fifteen years old."
# sentence1 = book_name + " is written by " + author + "."
sentence2 = f"The success of {book_name} by {author} continues to be an inspiration to young authors everywhere"
